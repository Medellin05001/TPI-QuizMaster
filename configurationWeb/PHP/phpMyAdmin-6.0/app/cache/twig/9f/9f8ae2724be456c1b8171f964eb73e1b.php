...
class __TwigTemplate_dabe5a8944a1e3bdf4c849d8de60f35e extends Template
{
    private $source;
    private $macros = [];
  ...
  <h2>
    ";
        // line 3
        echo $this->env->getFunction('get_icon')->getCallable()("s_db", ((($context["has_statistics"] ?? null)) ? (_gettext("Databases statistics")) : (_gettext("Databases"))));
        echo "
  </h2>
...
($context["url_params"] ?? null), $this->env->getFunction('url')->getCallable()("/server/databases"), "frame_content",             // line 88
        ...
        <table class=\"table table-striped table-hover w-auto\">
          <thead>
            ...
            echo "              <th>
                <a href=\"";
            // line 101
            echo $this->env->getFunction('url')->getCallable()("/server/databases", twig_array_merge(($context["url_params"] ?? null), ["sort_by" => "SCHEMA_NAME", "sort_order" => ((((twig_get_attribute($this->env, $this->source,             // line 103
...
echo _gettext("Database");
            ...
            echo "                </a>
              ...
              <th>
                <a href=\"";
            // line 118
            echo $this->env->getFunction('url')->getCallable()("/server/databases", twig_array_merge(($context["url_params"] ?? null), ["sort_by" => "DEFAULT_COLLATION_NAME", "sort_order" => ((((twig_get_attribute($this->env, $this->source,             // line 120
...
echo _gettext("Collation");
            ...
            if (($context["has_statistics"] ?? null)) {
                ...
                foreach ($context['_seq'] as $context["name"] => $context["statistic"]) {
                    ...
                    <a href=\"";
                    // line 137
                    echo $this->env->getFunction('url')->getCallable()("/server/databases", twig_array_merge(($context["url_params"] ?? null), ["sort_by" =>                     // line 138
