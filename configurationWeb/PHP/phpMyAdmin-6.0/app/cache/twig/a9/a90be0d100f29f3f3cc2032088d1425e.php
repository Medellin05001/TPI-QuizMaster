...
class __TwigTemplate_cbc4f229ceebcb1a9c587fcb06b79ed0 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <p class=\"d-print-none\">
    ...
    <a href=\"";
            // line 20
            echo $this->env->getFunction('url')->getCallable()("/database/data-dictionary", ["db" => ($context["database"] ?? null), "goto" => $this->env->getFunction('url')->getCallable()("/database/structure")]);
            echo "\">
      ";
            // line 21
            echo $this->env->getFunction('get_icon')->getCallable()("b_tblanalyse", _gettext("Data dictionary"), true);
            echo "
    </a>
  </p>
";
...
";
    ...
    {
        return new Source("", "database/structure/index.twig", "C:\\Users\\pz24gvr\\Desktop\\phpMyAdmin-6.0+snapshot-all-languages\\resources\\templates\\database\\structure\\index.twig");
    }
}
