...
class __TwigTemplate_dde0cfd7affe0567a73f842385df7bdc extends Template
{
    private $source;
    private $macros = [];
    ...
    <li class=\"nav-item\">
      <a href=\"";
            // line 4
            echo $this->env->getFunction('url')->getCallable()("/table/structure", ["db" => ($context["db"] ?? null), "table" => ($context["table"] ?? null)]);
    ...
    <li class=\"nav-item\">
      <a href=\"";
            // line 10
            echo $this->env->getFunction('url')->getCallable()("/table/relation", ["db" => ($context["db"] ?? null), "table" => ($context["table"] ?? null)]);
...
";
    ...
    {
        return new Source("", "table/page_with_secondary_tabs.twig", "C:\\Users\\pz24gvr\\Desktop\\PHP\\phpMyAdmin-6.0\\resources\\templates\\table\\page_with_secondary_tabs.twig");
    }
}
