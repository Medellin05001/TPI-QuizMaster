...
class __TwigTemplate_be58285bfcfc3072772e75165361d4c6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <th>
        <a href=\"";
        // line 10
        echo $this->env->getFunction('url')->getCallable()("/sql", twig_array_merge(($context["table_url_params"] ?? null), ["pos" => 0]));
        echo "\" title=\"";
    ...
    ";
        ...
        if (($context["server_replica_status"] ?? null)) {
            ...
            ";
            // line 17
            echo ((($context["ignored"] ?? null)) ? ($this->env->getFunction('get_image')->getCallable()("s_cancel", _gettext("Not replicated"))) : (""));
            echo "
            ";
            // line 18
            echo ((($context["do"] ?? null)) ? ($this->env->getFunction('get_image')->getCallable()("s_success", _gettext("Replicated"))) : (""));
            echo "
        </td>
    ";
        }
...
($context["already_favorite"] ?? null)]));
    ...
    <td class=\"text-center d-print-none\">
        ...
        echo "\">
          ";
        // line 43
        echo ((($context["may_have_rows"] ?? null)) ? ($this->env->getFunction('get_icon')->getCallable()("b_browse", _gettext("Browse"))) : ($this->env->getFunction('get_icon')->getCallable()("bd_browse", _gettext("Browse"))));
        echo "
        </a>
    </td>
    <td class=\"text-center d-print-none\">
        <a href=\"";
        // line 47
        echo $this->env->getFunction('url')->getCallable()("/table/structure", ($context["table_url_params"] ?? null));
        echo "\">
          ";
        // line 48
    ...
    <td class=\"text-center d-print-none\">
        <a href=\"";
        // line 52
        echo $this->env->getFunction('url')->getCallable()("/table/search", ($context["table_url_params"] ?? null));
        echo "\">
          ";
        // line 53
        echo ((($context["may_have_rows"] ?? null)) ? ($this->env->getFunction('get_icon')->getCallable()("b_select", _gettext("Search"))) : ($this->env->getFunction('get_icon')->getCallable()("bd_select", _gettext("Search"))));
        echo "
        </a>
    </td>
    ...
    ";
        ...
        if ( !($context["db_is_system_schema"] ?? null)) {
            ...
            <a href=\"";
            // line 59
            echo $this->env->getFunction('url')->getCallable()("/table/change", ($context["table_url_params"] ?? null));
            echo "\">";
...
($context["current_table"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["TABLE_NAME"] ?? null) : null)]);
        ...
        ";
                ...
                echo "\" data-post=\"";
                echo $this->env->getFunction('get_common')->getCallable()(twig_array_merge(($context["table_url_params"] ?? null), ["sql_query" =>                 // line 71
...
($context["empty_table_message_to_show"] ?? null)]), "");
                ...
                echo "\">
                  ";
                // line 74
                echo ((($context["may_have_rows"] ?? null)) ? ($this->env->getFunction('get_icon')->getCallable()("b_empty", _gettext("Empty"))) : ($this->env->getFunction('get_icon')->getCallable()("bd_empty", _gettext("Empty"))));
                echo "
                </a>
          </td>
        ";
            ...
            echo "\" data-post=\"";
            // line 81
            echo $this->env->getFunction('get_common')->getCallable()(twig_array_merge(($context["table_url_params"] ?? null), ["reload" => 1, "purge" => 1, "sql_query" =>             // line 84
...
($context["current_table"] ?? null)) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["ENGINE"] ?? null) : null) != null) || ($context["table_is_view"] ?? null)))) {
            ...
            // line 95
            echo "        ";
            $context["row_count"] = $this->env->getFunction('format_number')->getCallable()((($__internal_compile_6 = ($context["current_table"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["TABLE_ROWS"] ?? null) : null), 0);
            // line 96
            echo "
        ";
            // line 99
