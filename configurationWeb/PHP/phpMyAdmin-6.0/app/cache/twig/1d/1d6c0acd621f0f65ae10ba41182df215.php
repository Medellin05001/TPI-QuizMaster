...
class __TwigTemplate_5997df5f84dadcffbde89af9df770957 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Exporting a raw query");
  ...
  ";
    ...
    public function block_selection_options($context, array $blocks = [])
    {
        ...
        if ((($context["export_type"] ?? null) != "raw")) {
            // line 13
            echo "    <div class=\"card mb-3 d-none\" id=\"databases_and_tables\">
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\Users\\pz24gvr\\Desktop\\PHP\\phpMyAdmin-6.0\\resources\\templates\\database\\export\\index.twig");
    }
}
